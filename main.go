...
Cookie: PHPSESSION=55523704asafsdffg0; a=123; b=456
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36
Connection: keep-alive
`
	err, respBody := tools.HttpUrl("https://baidu.com", "POST", []byte("a=1&b=2"), "PHPSESSION=AAAAA; b=777; c=888", head, true, "http://127.0.0.1:8080", 60, 0, true)
	fmt.Println("=== err ===", err)
	fmt.Println("=== 响应内容 ===", string(respBody.Body))
}
